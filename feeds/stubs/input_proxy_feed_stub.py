    ...
    def fetch(
        ...
        if self._failure_mode == "observed":
            ...
            base_observation["provenance"] = {
                "source": f"{self.STUB_MARKER}_input_proxy_source",
